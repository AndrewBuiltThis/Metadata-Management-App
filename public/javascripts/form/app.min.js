! function(e, n, a) {
    ...
    a(e).on("load", function() {
        ...
        !1 === a.app.nav.initialized && a.app.nav.init({
            ...
            e.preventDefault(), a(this).closest(".card").children(".card-content").collapse("toggle"), a(this).closest(".card").find('[data-action="collapse"] i').toggleClass("ft-minus ft-plus")
        ...
        var e = i.data("menu");
        "horizontal-menu" != e && ("vertical-menu-modern" == i.data("menu") ? "true" === localStorage.getItem("menuLocked") && a(".main-menu-content").find("li.active").parents("li").addClass("open") : a(".main-menu-content").find("li.active").parents("li").addClass("open")), "horizontal-menu" == e && (a(".main-menu-content").find("li.active").parents("li:not(.nav-item)").addClass("open"), a(".main-menu-content").find("li.active").parents("li").addClass("active")), a(".heading-elements-toggle").on("click", function() {
            a(this).parent().children(".heading-elements").toggleClass("visible")
        });
        var n = a(".chartjs"),
            o = n.children("canvas").attr("height");
        if (n.css("height", o), i.hasClass("boxed-layout") && i.hasClass("vertical-overlay-menu")) {
            var s = a(".main-menu").width(),
                l = a(".app-content").position().left - s;
            i.hasClass("menu-flipped") ? a(".main-menu").css("right", l + "px") : a(".main-menu").css("left", l + "px")
        }
        a(".nav-link-search").on("click", function() {
            a(this);
            var e = a(this).siblings(".search-input");
            e.hasClass("open") ? e.removeClass("open") : e.addClass("open")
        })
    }), a(n).on("click", ".menu-toggle, .modern-nav-toggle", function(n) {
        return n.preventDefault(), a.app.menu.toggle(), setTimeout(function() {
            a(e).trigger("resize")
        }, 200), a("#collapsed-sidebar").length > 0 && setTimeout(function() {
            i.hasClass("menu-expanded") || i.hasClass("menu-open") ? a("#collapsed-sidebar").prop("checked", !1) : a("#collapsed-sidebar").prop("checked", !0)
        }, 1e3), !1
    }), a(n).on("click", ".open-navbar-container", function(e) {
        var n = Unison.fetch.now();
        a.app.menu.drillDownMenu(n.name)
    }), a(n).on("click", ".main-menu-footer .footer-toggle", function(e) {
        return e.preventDefault(), a(this).find("i").toggleClass("pe-is-i-angle-down pe-is-i-angle-up"), a(".main-menu-footer").toggleClass("footer-close footer-open"), !1
    ...
    }), "undefined" != typeof screenfull && screenfull.enabled && a(n).on(screenfull.raw.fullscreenchange, function() {
        ...
        var e = a(this),
            n = e.attr("href"),
            t = e.closest(".nav");
        t.find(".nav-link").removeClass("active"), e.closest(".nav-item").find(".nav-link").addClass("active"), e.closest(".dropdown-menu").find(".dropdown-item").removeClass("active"), e.addClass("active"), t.next().find(n).siblings(".tab-pane").removeClass("active in").attr("aria-expanded", !1), a(n).addClass("active in").attr("aria-expanded", "true")
